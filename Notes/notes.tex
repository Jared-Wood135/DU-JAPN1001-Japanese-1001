...
\subsection{たんご（単語）- Vocabulary (L1 Quiz)}
...
\begin{tabularx}{\linewidth}{X | X | X}
    ...
    きいろ & 黄色 & Yellow \\
    はれ & 晴れ & Sunny \\
    きをつけて & 気をつけて & Watch out! \\
    しんり & 心理 & Psychology \\
    わかる & 分かる & To understand \\
    れきし & 歴史 & History (Major) \\
    めをさます & 目を覚ます & Wake Up \\
    りろん & 理論 & Theory \\
    らいねん & 来年 & Next Year \\
    はんえい & 繁栄 & Prosperity \\
...
\newpage
\subsection{すうじ（数字時）- Suuji (Larger Numbers)}
Note that 10000 is 一万(ichi-man) while 10 (十：jyuu), (百：hyaku), (千：sen) do not have 一(ichi)
\vspace{5pt}
\begin{tabularx}{\linewidth}{X | X | X}
    \toprule
    \textbf{Japanese (日本語)} & \textbf{Kanji} & \textbf{English (英語)} \\
    ...
    ひゃく & 百 & 100 \\
    にひゃく & 二百 & 200 \\
    \colorbox{yellow}{さんびゃく} & 三百 & \colorbox{yellow}{300} \\
    よんひゃく & 四百 & 400 \\
    ごひゃく & 五百 & 500 \\
    \colorbox{yellow}{ろっぴゃく} & 六百 & \colorbox{yellow}{600} \\
    ななひゃく & 七百 & 700 \\
    \colorbox{yellow}{はっぴゃく} & 八百 & \colorbox{yellow}{800} \\
    きゅうひゃく & 九百 & 900 \\
    せん & 千 & 1000 \\
    にせん & 二千 & 2000 \\
    \colorbox{yellow}{さんぜん} & 三千 & \colorbox{yellow}{3000} \\
    よんせん & 四千 & 4000 \\
    ごせん & 五千 & 5000 \\
    ろくせん & 六千 & 6000 \\
    ななせん & 七千 & 7000 \\
    \colorbox{yellow}{はっせん} & 八千 & \colorbox{yellow}{8000} \\
    きゅうせん & 九千 & 9000 \\
    \colorbox{yellow}{いちまん} & 一万 & \colorbox{yellow}{10000} \\
    にまん & 二万 & 20000 \\
    さんまん & 三万 & 30000 \\
    よんまん & 四万 & 40000 \\
    ごまん & 五万 & 50000 \\
...
% Page Contents
\subsection{たんご（単語）- Vocabulary (L2 Quiz)}
\begin{tabularx}{\linewidth}{X | X | X}
    \toprule
    \textbf{Japanese (日本語)} & \textbf{Kanji} & \textbf{English (英語)} \\
    \midrule
    \textbf{Words That Point} &  & \\
    これ & 此れ(Rarely used Kanji) & This one \\
    それ & 其れ(Rarely used Kanji) & That one \\
    あれ & 彼(Rarely used Kanji) & That one (Over there) \\
    どれ & 何れ(Rarely used Kanji) & Which one \\
    この & 此の(Rarely used Kanji) & This... \\
    その & 其の(Rarely used Kanji) & That... \\
    あの & 彼の(Rarely used Kanji) & That... (Over there) \\
    どの & 何の(Rarely used Kanji) & Which... \\
    ここ & 此処(Rarely used Kanji) & Here \\
    そこ & 其処(Rarely used Kanji) & There \\
    あそこ & 彼処(Rarely used Kanji) & Over there \\
    どこ & 何処(Obsolete Kanji) & Where \\
    だれ & 誰 & Who \\
    \hline
    \textbf{Food} &  & \\
    おいしい(Typical writing) & 美味しい & Delicious \\
    さかな & 魚 & Fish \\
    とんかつ(Typical writing) & 豚カツ & Pork Cutlet \\
    にく & 肉 & Meat \\
    メニュー & NONE & Menu \\
    やさい & 野菜 & Vegetable \\
    \hline
    \textbf{Things} &  & \\
    かさ & 傘 & Umbrella \\
    かばん(Typical writing) & 鞄 & Bag \\
    くつ & 靴(Rarely used Kanji) & Shoes \\
    さいふ & 財布 & Wallet \\
    ジーンズ & NONE & Jeans \\
    じてんしゃ & 自転車 & Bicycle \\
    しんぶん & 新聞 & Newspaper \\
    スマホ & NONE & Smartphone \\
    Tシャツ & NONE & T-Shirt \\
    とけい & 時計(Rarely used Kanji) & Watch; Clock \\
    ノート & NONE & Notebook \\
    ペン & NONE & Pen \\
    ぼうし(Typical writing) & 帽子 & Hat; Cap \\
    ほん & 本 & Book \\
    \bottomrule
\end{tabularx}
\newpage
\begin{tabularx}{\textwidth}{X | X | X}
    ...
    \textbf{Places} &  & \\
    ぎんこう & 銀行 & Bank \\
    コンビニ & NONE & Convenience Store \\
    トイレ & NONE & Toilet; Restroom \\
    としょかん & 図書館 & Library \\
    ...
    \hline
    \textbf{Money Matters} &  & \\
    いくら(Typical writing) & 幾ら & How much \\
    えん & 円 & ...yen \\
    たかい & 高い & Expensive; High \\
    \hline
    \textbf{Expressions} &  & \\
    いらっしゃいませ & NONE & Welcome (To our store) \\
    （〜を）おねがいします & お願いします & ...please \\
    （〜を）ください(Typical writing) & 下さい & Please give me... \\
    じゃあ & NONE & then...; If that's the case... \\
    どうぞ & NONE & Please; Here it is \\
    どうも & NONE & Thank you \\
    \bottomrule
\end{tabularx}
